...
const TIERS: TierDef[] = [
  {
    ...
    bullets: [
      ...
      'AspenX sends you a CloudFormation bootstrap template after checkout',
      'Deploy the template to create a deployment IAM role — AspenX never touches root credentials',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Optional support add-on: $200/mo, up to 2 hrs/mo of minor infra changes by a senior DevOps engineer',
    ],
  ...
  },
  {
    tier: 3,
    name: 'IaC Kit',
    tagline: 'Production-ready IaC code + instructions, you deploy',
    ...
    bullets: [
      ...
      'Choose your format: Terraform or CloudFormation',
      'AspenX delivers production-ready IaC modules for your recipe',
      'Detailed step-by-step deployment guide included',
      'You deploy — you own the result',
      'You pay AWS directly — no markup from AspenX',
    ],
